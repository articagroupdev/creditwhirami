...
Services
              ...
              <li>
                <Link href="#faq" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
                  FAQ
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">2625 SE 13th St. Homestead, FL 33035</span>
              </li>
            </ul>
          </div>
        </div>
